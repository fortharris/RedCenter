        ...
        for i in self.deleteKeyList:
            if self.stopThread == False:
                ...
                try:
                    ...
                    value = len(self.successDeleteList) * 100 / len(self.deleteKeyList)
...
class Delete(QtGui.QWidget):
    ...
    def deleteFinished(self):
        ...
        new_size = self.vaultManager.vaultContentsSize - self.deleteThread.deleteSize
    ...
    def updateVaultListWidget_deleteList(self):
        ...
        self.vaultManager.vaultItemCountLabel.setText("Items: " + str(self.vaultManager.count()))
